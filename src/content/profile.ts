...
export const profile: Profile = {
  ...
  bio: [
    ...
    "Today I lead product for AI infrastructure and automation at T-Mobile, where my focus is DevSecOps, infrastructure-as-code, and execution governance. I care about the unglamorous parts of platform work: paved roads, sane defaults, and clear ownership — the things that compound into real velocity.",
