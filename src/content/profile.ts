...
export const profile: Profile = {
  name: "Kamal Bhatia",
  role: "AI Builder. Creative Thinker. Mama.",
  tagline:
  ...
  bio: [
    ...
    "In my current role, I lead Automation Platforms in a hybrid cloud environment, including CI/CD execution platforms, Terraform Enterprise agent pools, and dependency resource graph systems. My focus is on execution reliability, change safety, governance, and scalability — essentially turning complex infrastructure capabilities into products that teams can adopt and trust.",
